...
Phase 7 — Basic editing, branch `feat/phase-7-basic-editing`. In progress (Steps 1–7 done,
checkpoint `a1cf682`; Step 8 text clips implemented, not checkpointed); plan, product decisions and
